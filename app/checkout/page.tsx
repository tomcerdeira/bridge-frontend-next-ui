				...
				<Card className="max-w-[400px]">
					...
					<div className="flex gap-4 items-center justify-center">
						<Button isIconOnly aria-label="Like">
							{/* TODO: cambiar SVG para tarjeta de credito/debito */}
							<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130" viewBox="0 0 200 130">
							<rect x="0" y="0" width="200" height="130" rx="12" ry="12" fill="#1565c0" />
							<rect x="20" y="20" width="160" height="90" rx="8" ry="8" fill="#f0f0f0" />
							<rect x="30" y="35" width="140" height="10" rx="2" ry="2" fill="#bdbdbd" />
							<rect x="30" y="55" width="100" height="10" rx="2" ry="2" fill="#bdbdbd" />
							<rect x="30" y="75" width="120" height="10" rx="2" ry="2" fill="#bdbdbd" />
							<circle cx="160" cy="100" r="12" fill="#ff7043" />
							<rect x="150" y="90" width="20" height="20" rx="2" ry="2" fill="#f0f0f0" />
							</svg>
						</Button>
						<Button isIconOnly aria-label="Like">
