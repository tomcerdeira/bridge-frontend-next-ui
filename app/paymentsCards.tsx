...
export default function PaymentsCards({ shop_analytics } : PaymentsCardsProps) {    
    return (
        <>
            ...
            <AnalyticsCard card_color="bg-success" card_title="Pagos exitosos" card_content={shop_analytics.paymentsSucceeded} />
            <AnalyticsCard card_color="bg-danger" card_title="Pagos fallidos" card_content={shop_analytics.paymentsFailed} />
